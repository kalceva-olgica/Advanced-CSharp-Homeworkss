   ...
   public static class CarsData
    {
            ...
            Cars = new List<Car>()
       {
           ...
           new Car() { Model = "Pontiac Catalina Brougham", MilesPerGalon = 14, AccelerationTime = 14.5, Cylinders = 8, HorsePower = 175, Origin = "US", Weight = 4464 },
           new Car() { Model = "Ford Galaxie 500", MilesPerGalon = 14, AccelerationTime = 20.5, Cylinders = 8, HorsePower = 153, Origin = "US", Weight = 4154 },
           new Car() { Model = "Plymouth Fury iii", MilesPerGalon = 14, AccelerationTime = 13, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 4096 },
           new Car() { Model = "Dodge Monaco (sw)", MilesPerGalon = 12, AccelerationTime = 17.5, Cylinders = 8, HorsePower = 180, Origin = "US", Weight = 4955 },
           ...
           new Car() { Model = "AMC Hornet Sportabout (sw)", MilesPerGalon = 18, AccelerationTime = 14.5, Cylinders = 6, HorsePower = 110, Origin = "US", Weight = 2962 },
           ...
           new Car() { Model = "Ford Mustang", MilesPerGalon = 18, AccelerationTime = 17.5, Cylinders = 6, HorsePower = 88, Origin = "US", Weight = 3139 },
           ...
           new Car() { Model = "Peugeot 304", MilesPerGalon = 30, AccelerationTime = 12.5, Cylinders = 4, HorsePower = 70, Origin = "Europe", Weight = 2074 },
           new Car() { Model = "Fiat 124B", MilesPerGalon = 30, AccelerationTime = 13.5, Cylinders = 4, HorsePower = 76, Origin = "Europe", Weight = 2065 },
           ...
           new Car() { Model = "Plymouth Cricket", MilesPerGalon = 26, AccelerationTime = 14.5, Cylinders = 4, HorsePower = 70, Origin = "US", Weight = 1955 },
           ...
           new Car() { Model = "Ford Pinto", MilesPerGalon = 19, AccelerationTime = 16.5, Cylinders = 4, HorsePower = 85, Origin = "US", Weight = 2310 },
           new Car() { Model = "Mercury Capri v6", MilesPerGalon = 21, AccelerationTime = 14, Cylinders = 6, HorsePower = 107, Origin = "US", Weight = 2472 },
           new Car() { Model = "Fiat 124 Sport Coupe", MilesPerGalon = 26, AccelerationTime = 16.5, Cylinders = 4, HorsePower = 90, Origin = "Europe", Weight = 2265 },
           ...
           new Car() { Model = "Toyota Mark II", MilesPerGalon = 19, AccelerationTime = 155, Cylinders = 6, HorsePower = 108, Origin = "Japan", Weight = 2930 },
